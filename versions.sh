...
declare -A VERSIONS=(
    ...
    ["PHP 7.2.27"]="https://www.php.net/distributions/php-7.2.25.tar.gz"
    ["PHP 7.3.14"]="https://www.php.net/distributions/php-7.3.12.tar.gz"
    ["PHP 7.4.2"]="https://www.php.net/distributions/php-7.4.0.tar.gz"
)
